...
parser.add_argument('-v2d', '--vars_2d', help='List of 2d variables to be checked',
                    required=False, default=['t_2m'], nargs='+')
...
var_2d_list = ['aswdifd_s', 'aswdifu_s',
               'athb_s', 'cape_ml', 'clch', 'clcl', 'clcm', 'clct',
...
def find_file_name(vars_2d=None,
                   ...
                   date_string=None,
                   run_string=None):
    f_times = list(range(0, 49)) + list(range(51, 73, 3)) + list(range(78, 121, 6))
    #
    ...
    if vars_2d is not None:
        for var in vars_2d:
            ...
            for f_time in f_times:
                var_url = "icon-eu-eps_europe_icosahedral_single-level"
    ...
    if vars_3d is not None:
        for var in vars_3d:
            ...
            for plev in levels_3d:
                for f_time in f_times:
                    var_url = "icon-eu-eps_europe_icosahedral_pressure-level"
...
def get_most_recent_run(run=None, vars_2d=['t_2m'], vars_3d=None,
                        levels_3d=None):
